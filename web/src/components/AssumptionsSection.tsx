...
export function AssumptionsSection() {
  return (
    <section className="rounded-lg border bg-card text-card-foreground shadow-sm" id="assumptions">
      <div className="flex flex-col space-y-1.5 p-6">
        <h3 className="text-2xl font-semibold leading-none tracking-tight">模型假设</h3>
      </div>
